    ...
    return (
        <div className="home">
            ...
            <div className="home__row">
                <Product id={56239} title='The lean startup' price={29.99} image='https://m.media-amazon.com/images/I/81-QB7nDh4L._AC_UY218_.jpg' rating={5} />
            ...
            <div id={43554} className="home__row">
            ...
            <div className="home__row">
                <Product id={1123} title='SAMSUNG 55-Inch Class Crystal UHD TU-8000 Series - 4K UHD HDR Smart TV with Alexa Built-in + HW-T650 3.1ch Soundbar with 3D Surround Sound (2020) ' price={400} image='https://m.media-amazon.com/images/I/41HUkfTDYFL._AC_UY218_.jpg' />
